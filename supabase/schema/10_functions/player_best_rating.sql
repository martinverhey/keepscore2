...
revoke all on function public.player_best_rating(p_player_id uuid) from public, anon, authenticated;
grant execute on function public.player_best_rating(p_player_id uuid) to authenticated;
