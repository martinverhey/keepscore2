...
create or replace function public.season_game_types(p_competition_id uuid)
...
revoke all on function public.season_game_types(p_competition_id uuid) from public, anon, authenticated;
grant execute on function public.season_game_types(p_competition_id uuid) to authenticated;
