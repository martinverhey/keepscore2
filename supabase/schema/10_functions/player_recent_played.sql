...
revoke all on function public.player_recent_played(p_season_id uuid, p_player_id uuid) from public, anon, authenticated;
grant execute on function public.player_recent_played(p_season_id uuid, p_player_id uuid) to authenticated;
