...
revoke all on function public.player_best_streaks(p_player_id uuid) from public, anon, authenticated;
grant execute on function public.player_best_streaks(p_player_id uuid) to authenticated;
