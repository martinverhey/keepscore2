...
revoke all on function public.leave_competition(p_competition_id uuid) from public, anon, authenticated;
grant execute on function public.leave_competition(p_competition_id uuid) to authenticated;
