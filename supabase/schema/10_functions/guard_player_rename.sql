...
revoke all on function public.guard_player_rename() from public, anon, authenticated;
grant execute on function public.guard_player_rename() to anon, authenticated;
